!(function (e, t) {
    ...
    var e,
        ...
        n = ["Webkit", "Moz", "ms"],
        o =
            "undefined" != typeof document ? document.createElement("div").style : {},
        r = [1, 8, 3, 6],
        a = [2, 7, 4, 5];
    function s(e) {
        if (e in o) return e;
    ...
    (g.parse = function (e) {
        ...
        (g.fromMatrix = function (e) {
            ...
            return (
                ...
                new g(m(t[4]), m(t[5]), parseFloat(t[0]))
            );
        }),
    ...
    function x() {
        var n,
            ...
            s,
            l,
            h = this.options.viewport.type
                ? "cr-vp-" + this.options.viewport.type
                : null;
        (this.options.useCanvas = this.options.enableOrientation || C.call(this)),
            (this.data = {}),
            (this.elements = {}),
            (n = this.elements.boundary = document.createElement("div")),
            (r = this.elements.viewport = document.createElement("div")),
            (o = this.elements.img = document.createElement("img")),
            (a = this.elements.overlay = document.createElement("div")),
            this.options.useCanvas
                ? ((this.elements.canvas = document.createElement("canvas")),
                    (this.elements.preview = this.elements.canvas))
                : (this.elements.preview = o),
            p(n, "cr-boundary"),
            n.setAttribute("aria-dropeffect", "none"),
            (s = this.options.boundary.width),
            (l = this.options.boundary.height),
            c(n, {
                width: s + (isNaN(s) ? "" : "px"),
                height: l + (isNaN(l) ? "" : "px"),
            }),
            ...
            p(this.elements.preview, "cr-image"),
            d(this.elements.preview, { alt: "preview", "aria-grabbed": "false" }),
            p(a, "cr-overlay"),
            this.element.appendChild(n),
            n.appendChild(this.elements.preview),
            n.appendChild(r),
            n.appendChild(a),
            p(this.element, "croppie-container"),
            this.options.customClass && p(this.element, this.options.customClass),
            function () {
                var e,
                    n,
                    o,
            ...
            function () {
                ...
                function r() {
                    (function (i) {
                        ...
                        function s() {
                            ...
                            (i[t] = o.toString()),
                                (i[e] = a.toString()),
                                c(n.elements.preview, i);
                        }
                        if (
                            ((n._currentZoom = i ? i.value : n._currentZoom),
                ...
                p(n, "cr-slider-wrap"),
                    ...
                    n.appendChild(o),
                    (i._currentZoom = 1),
                    i.elements.zoomer.addEventListener("input", r),
                    i.elements.zoomer.addEventListener("change", r),
                    i.options.mouseWheelZoom &&
                    (i.elements.boundary.addEventListener("mousewheel", a),
                        i.elements.boundary.addEventListener("DOMMouseScroll", a));
            }.call(this),
            ...
            function () {
                ...
                p(h, "cr-resizer"),
                    ...
                    (p((a = document.createElement("div")), "cr-resizer-vertical"),
                        h.appendChild(a));
    ...
    function W() {
        ...
        F.call(this) &&
            ...
            ((this.data.bound = !0),
                ...
                (this._originalImageWidth = i.width),
                (this._originalImageHeight = i.height),
                (this.data.orientation = C.call(this)
                    ? y(this.elements.img)
                    : this.data.orientation),
                this.options.enableZoom ? X.call(this, !0) : (this._currentZoom = 1),
                ...
                this.data.points.length
                    ? function (i) {
                        ...
                        var n = i[2] - i[0],
                            ...
                            d = {};
                        (d[e] = h + "px " + l + "px"),
                            (d[t] = new g(p, u, s).toString()),
                            c(this.elements.preview, d),
                            E.call(this, s),
                            (this._currentZoom = s);
    ...
    function X(e) {
        ...
        this.options.enforceBoundary &&
            ...
            (s.max = O(a, 4)),
            !e && (l < s.min || l > s.max)
                ? E.call(this, l < s.min ? s.min : s.max)
                : e &&
                ((i = Math.max(h.width / c.width, h.height / c.height)),
    ...
    function Y(e) {
        ...
        var c = i,
            ...
            y = u;
        return (
            i < 0 && ((c = 0), (v = (Math.abs(i) / o) * h)),
            d + c > this._originalImageWidth &&
            (w = ((d = this._originalImageWidth - c) / o) * h),
            n < 0 && ((p = 0), (g = (Math.abs(n) / r) * u)),
            f + p > this._originalImageHeight &&
            (y = ((f = this._originalImageHeight - p) / r) * u),
            l.drawImage(this.elements.preview, c, p, d, f, v, g, w, y),
            a &&
            ((l.fillStyle = "#fff"),
        ...
        return (
            ...
            (function (e, t) {
                ...
                if (
                    ...
                    n.options.relative &&
                        (o = [
                            (o[0] * i.naturalWidth) / 100,
                            (o[1] * i.naturalHeight) / 100,
                            (o[2] * i.naturalWidth) / 100,
                            (o[3] * i.naturalHeight) / 100,
                        ]);
                else {
                    var r,
                        a,
                ...
                (n.data.orientation = e.orientation || 1),
                    ...
                    function (e) {
                        ...
                        t.getContext("2d").clearRect(0, 0, t.width, t.height),
                            (t.width = i.width),
                            (t.height = i.height),
                            b(t, i, (this.options.enableOrientation && e) || y(i));
                    }.call(n, n.data.orientation),
                    W.call(n),
                    z.call(n),
                    t && t();
            })
                        ...
                        e(
                            function (e) {
                                ...
                                return (
                                    p(i, "croppie-result"),
                                    i.appendChild(n),
                                    c(n, { left: -1 * t[0] + "px", top: -1 * t[1] + "px" }),
                                    (n.src = e.url),
                                    c(i, { width: o + "px", height: r + "px" }),
                                    i
                                );
                            }.call(t, i)
                        );
        ...
        if (
            ((this.data.orientation =
                ((t = this.data.orientation),
                    ...
                    (o = n.indexOf(t)),
                    (s = (i / 90) % n.length),
                    n[(n.length + o + (s % n.length)) % n.length])),
                b(l, this.elements.img, this.data.orientation),
                _.call(this, !0),
                X.call(this),
                (Math.abs(e) / 90) % 2 == 1)
        ) {
